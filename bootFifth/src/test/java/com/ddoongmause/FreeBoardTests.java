...
import com.ddoongmause.domain.FreeBoard;
import com.ddoongmause.domain.FreeBoardReply;
import com.ddoongmause.persistence.FreeBoardReplyRepository;
import com.ddoongmause.persistence.FreeBoardRepository;
...
public class FreeBoardTests {
	...
	public void insertDummy() {
		/*
		 * IntStream.range(1, 200).forEach(i ->{ FreeBoard board = new FreeBoard();
		 * board.setTitle("Free Board ..." + i); board.setContent("Free Content..." +
		 * i); board.setWriter("user" + i%10);
		 * 
